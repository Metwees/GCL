...
def mean_ap(distmat, query_ids=None, gallery_ids=None,
            query_cams=None, gallery_cams=None, separate_camera_set=False):
...
def evaluate_all(distmat, query_ids, gallery_ids, query_cams, gallery_cams, cmc_topk=(1, 5, 10, 20), cmc_flag=False, separate_camera_set=False):

    # Compute mean AP
    mAP = mean_ap(distmat, query_ids, gallery_ids, query_cams, gallery_cams, separate_camera_set=separate_camera_set)
    ...
    cmc_configs = {
        'market1501': dict(separate_camera_set=separate_camera_set,
                           single_gallery_shot=False,
